	...
	return (
		<>
			<Head>
				...
				{props.post && (
					<>
						...
						<meta property="og:image" content={`${props.post.image.replace('https://gateway.ipfs.io/ipfs/', AppConfig.ipfs_gateway)}`} key="og:image" />
								...
								__html: `
          {
            ...
            "image": ["${props.post.image.replace('https://gateway.ipfs.io/ipfs/', AppConfig.ipfs_gateway)}"],
